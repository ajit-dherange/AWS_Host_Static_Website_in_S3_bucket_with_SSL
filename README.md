...
5. A hosted zone for your custom domain name

6. A resource that can access your VPC network, such as an Amazon Elastic Compute Cloud (Amazon EC2) instance running inside of the VPC

7. A static website containing an index.html entry page populated into your S3 bucket
